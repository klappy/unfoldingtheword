...
const typeColors: Record<SearchResultType, { text: string; bg: string; border: string }> = {
  scripture: { text: 'text-amber-400', bg: 'bg-amber-400/10', border: 'border-amber-400/30' },
  notes: { text: 'text-emerald-400', bg: 'bg-emerald-400/10', border: 'border-emerald-400/30' },
  questions: { text: 'text-violet-400', bg: 'bg-violet-400/10', border: 'border-violet-400/30' },
  words: { text: 'text-rose-400', bg: 'bg-rose-400/10', border: 'border-rose-400/30' },
  academy: { text: 'text-sky-400', bg: 'bg-sky-400/10', border: 'border-sky-400/30' },
};
